...
export function generateRtpCapabilities1(
  ...
  loggerError("BUG [SdpEndpoint.generateRtpCapabilities1] Not implemented");
  process.exit(1);
...
export function generateRtpCapabilities2(
  ...
  loggerError("BUG [SdpEndpoint.generateRtpCapabilities2] Not implemented");
  process.exit(1);
